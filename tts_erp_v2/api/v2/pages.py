  ...
  <main class="op-main">
    ...
    <section class="op-counter px-2 px-md-4 py-3 py-md-4" id="summaries" aria-live="polite">
      <div class="row g-2 g-md-3 text-center row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5">
        ...
        <div class="col"><span class="op-counter-item"><span class="op-counter-label">GMV $<span class="op-hint" data-tip="全部订单销售额 = 有效销售 + 已付被取消订单的原始行金额（同一 paid_at 窗口）；≠ 行内「平台GMV」广告归因口径">?</span></span><span class="op-counter-num" id="sum-gmv">—</span></span></div>
        ...
        <div class="col"><span class="op-counter-item"><span class="op-counter-label">总单量<span class="op-hint" data-tip="总单量 = 有效订单数 + 已付被取消订单数（全部已付款订单，paid_at 落窗）">?</span></span><span class="op-counter-num" id="sum-total-orders">—</span></span></div>
