...
| feat/roi-date-truth | ROI 工具栏：起始/截止日按数据真实跨度回填(coverage meta) + review 日期过滤语义 + 含无活动 ? hover 解释 | 本会话 | .worktrees/roi-date-truth | tts_erp_v2/api/v2/analytics.py、tts_erp_v2/api/v2/pages.py(ROI 模板)、tts_erp_v2/static/js/spu-roi.js、tests/api/test_spu_roi_api.py、handoff/ACTIVE.md | draft | 2026-09-06T07:10Z |
