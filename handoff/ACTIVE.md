...
| feat/spu-roi-v7 | pages/spu-roi 按 rubric v7 重构（SETTLEMENT 分层净利 + 全损 38301 货本补扣 + M19 信息列化 + 行点击钻取面板五 tab + 四个懒加载端点 + 结算组件零值落库与回填）；设计稿 tech-doc/analytics/spu-roi-v7-refactor.md | 本 session | （设计完成，待开工） | tech-doc/analytics/spu-roi-v7-refactor.md(新)；实施后扩到 analytics.py/spu_roi.py/pages.py/spu-roi.js/jobs/tiktok/finance.py/scripts/oneoff_backfill_settlement_zero_components.py/tests | **done(设计)：D1–D7 全拍板，可开工** | 2026-09-07T19:50Z |
