...
| feat/roi-counter-tip | ROI 结余带 退款净额/全损货损 ? hover 口径解释 | 本会话 | .worktrees/roi-counter-tip | tts_erp_v2/api/v2/pages.py(ROI 模板)、tests/api/test_spu_roi_api.py、handoff/ACTIVE.md | draft | 2026-09-06T08:05Z |
