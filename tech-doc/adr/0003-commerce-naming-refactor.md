...
> ℹ️ **文件名变更（2026-09-05）**：原文件
> `0003-commerce-naming-refactor-pending.md` → 当前 `0003-commerce-naming-refactor.md`，
> 移除 "pending" 后缀（ADR 状态 = implemented，历史命名不再准确）。
