...
class TestEpochSeconds:
    ...
    def test_basic(self) -> None:
        ...
        assert result == datetime(2026, 8, 29, 10, 5, 15, tzinfo=timezone.utc)
...
class TestGmt8String:
    ...
    def test_basic(self) -> None:
        ...
        assert result == datetime(2026, 8, 29, 8, 18, 1, tzinfo=timezone.utc)
    ...
    def test_date_only(self) -> None:
        ...
        assert result == datetime(2026, 8, 28, 16, 0, 0, tzinfo=timezone.utc)
