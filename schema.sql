...
CREATE INDEX IF NOT EXISTS idx_oauth_tokens_provider ON public.oauth_tokens USING btree (provider);
...
\unrestrict yhsADFTlXAzUwNUrayrmot9dJakKX2E7nQzPT5kkdVdTj3BsPHVz2KedkpOh3pc
...
-- Name: idx_logistics_events_order; Type: INDEX; Schema: public; Owner: -

CREATE INDEX IF NOT EXISTS idx_logistics_events_order ON public.logistics_events USING btree (order_id, event_time DESC);


-- Name: idx_logistics_tracking_final; Type: INDEX; Schema: public; Owner: -

CREATE INDEX IF NOT EXISTS idx_logistics_tracking_final ON public.logistics_tracking USING btree (final_status);
...
CREATE INDEX IF NOT EXISTS idx_logistics_tracking_overseas ON public.logistics_tracking USING btree (arrived_overseas);
...
-- Name: idx_logistics_tracking_tracking; Type: INDEX; Schema: public; Owner: -

CREATE INDEX IF NOT EXISTS idx_logistics_tracking_tracking ON public.logistics_tracking USING btree (tracking_number);
...
-- Name: idx_lt_events_order; Type: INDEX; Schema: public; Owner: -

CREATE INDEX IF NOT EXISTS idx_lt_events_order ON public.logistics_tracking_events USING btree (order_id);
...
-- Name: logistics_events logistics_events_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
...
\unrestrict z7yQQuEDI3k6iPeax0PqBvnkLChidYeQFfH0ccA5ah0s4awowb0IERDaSafiCK3
